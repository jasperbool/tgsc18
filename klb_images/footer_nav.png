<!DOCTYPE html><html lang="en"><head><title>Action does not exist.</title><style type="text/css">::selection{ background-color: #E13300; color: white; }
...
<body>	<div id="container">		<h1>Action does not exist.</h1>		<p>...</p></div></body></html>