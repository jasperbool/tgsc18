...
echo $payUrlStr.SKL_WEBROOT_PATH.'index.php?c=Identify&rechargeType='.$post['rechargeType'].'&titleShort='.$post['titleShort'].'&isWriteNote='.$post['isWriteNote'].'&money='.$post['money'].'&cfg_stateField='.$this->cfg_stateField.'&cfg_stateValue='.$this->cfg_stateValue.'&fileName='.$post['fileName'].'&cfg_findOrderUrl='.urlencode($this->cfg_findOrderUrl).'&titleLong='.$post['titleLong'].'&returnUrl='.urlencode($post['returnUrl']); ?>" readonly></b></p>
