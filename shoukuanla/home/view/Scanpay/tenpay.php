...
.inputsty{ font-size: 16px; width: 230px; height: 28px; }
    ...
    .alipay-logo {
        ...
        background-repeat: no-repeat;
        background-image: url(<?php echo SKL_WEBROOT_PATH; ?>images/tenlogo.png);
    }
</style>
...
距离该订单过期还有：
    ...
    <strong id="second_show">0秒</strong>
            ...
            <a style="letter-spacing:2px;" id="J_OrderExtTrigger" class="order-ext-trigger" href="<?php echo $post['returnUrl']; ?>" seed="order-detail-more" data-role="J_oderDetailMore">
                返回网站
            </a>
...
if($post['isWriteNote'] == '1'){
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/tenqrcode.jpg?cacheTime='.$cacheTime.'" width="230" />
   ';	
}else{   
 	      
   echo '<img id="qrimage" src="'.SKL_WEBROOT_PATH.'images/tenqrcode/'.$post['money'].'/'.$post['fileName'].'?cacheTime='.$cacheTime.'" width="230" />
   ';	
}
?>           
...
<div class="qrguide-area" id="J_qrguideArea" seed="NewQr_animationClick">
    <img id="qrguideimg" src="<?php echo SKL_WEBROOT_PATH; ?>images/tenalert.png" class="qrguide-area-img active">
