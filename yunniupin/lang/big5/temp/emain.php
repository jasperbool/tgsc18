...
<div align="center"><a href="http://www.yunniupin.com/ecms6/" target="_blank"><strong><font color="#0000FF" size="3">帝國網站管理系統全面開源 
    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              ...
              <tr> 
                <td>2、本程序為免費代碼,用戶自由選擇是否使用，在使用中出現任何問題而造成的損失<strong><a href="http://www.yunniupin.com" target="_blank">帝國軟件</a></strong>不負任何責任。 
                </td>
              </tr>
              <tr> 
                <td>3、本程序不允許在沒有事先通知的情況下用於商業用途，假如您需要用於商業用途，請和<a href="http://www.yunniupin.com" target="_blank"><u>我們聯繫</u></a>，以獲得商業使用權。 
                </td>
              </tr>
              <tr> 
                <td>4、如果違反以上條款，<strong><a href="http://www.yunniupin.com" target="_blank">帝國軟件</a></strong>對此保留一切法律追究的權利。</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="3" cellspacing="1">
              <tr bgcolor="#FFFFFF"> 
                <td width="50%" height="25">官方主頁: <a href="http://www.yunniupin.com" target="_blank">http://www.yunniupin.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">官方論壇: <a href="http://bbs.yunniupin.com" target="_blank">http://bbs.yunniupin.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">公司網站：<a href="http://www.digod.com" target="_blank">http://www.digod.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">帝國產品：<a href="http://www.yunniupin.com/product" target="_blank">http://www.yunniupin.com/product</a></td>
              </tr>
            </table></td>
