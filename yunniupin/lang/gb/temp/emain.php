...
<div align="center"><a href="http://www.yunniupin.com/ecms6/" target="_blank"><strong><font color="#0000FF" size="3">帝国网站管理系统全面开源 
    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"> <table width="100%" border="0" align="center" cellpadding="3" cellspacing="1">
              ...
              <tr> 
                <td>2、本程序为免费代码,用户自由选择是否使用，在使用中出现任何问题而造成的损失<strong><a href="http://www.yunniupin.com" target="_blank">帝国软件</a></strong>不负任何责任。 
                </td>
              </tr>
              <tr> 
                <td>3、本程序不允许在没有事先通知的情况下用于商业用途，假如您需要用于商业用途，请和<a href="http://www.yunniupin.com" target="_blank"><u>我们联系</u></a>，以获得商业使用权。 
                </td>
              </tr>
              <tr> 
                <td>4、如果违反以上条款，<strong><a href="http://www.yunniupin.com" target="_blank">帝国软件</a></strong>对此保留一切法律追究的权利。</td>
              </tr>
            </table></td>
        </tr>
      </table></td>
    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="3" cellspacing="1" bgcolor="#DBEAF5">
              ...
              <tr bgcolor="#FFFFFF"> 
                <td height="25">程序版本&nbsp;&nbsp;: <a href="http://www.yunniupin.com" target="_blank"><strong><font color="#07519A">EmpireBak</font></strong> 
    ...
    <td><table width="98%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#0472BC">
        ...
        <tr> 
          <td bgcolor="#FFFFFF"><table width="100%" border="0" cellpadding="3" cellspacing="1">
              <tr bgcolor="#FFFFFF"> 
                <td width="50%" height="25">官方主页: <a href="http://www.yunniupin.com" target="_blank">http://www.yunniupin.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">官方论坛: <a href="http://bbs.yunniupin.com" target="_blank">http://bbs.yunniupin.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">公司网站：<a href="http://www.digod.com" target="_blank">http://www.digod.com</a></td>
              </tr>
              <tr bgcolor="#FFFFFF"> 
                <td height="25">帝国产品：<a href="http://www.yunniupin.com/product" target="_blank">http://www.yunniupin.com/product</a></td>
              </tr>
            </table></td>
...
<IFRAME frameBorder="0" name="getinfo" scrolling="no" src="ginfo.php" style="HEIGHT:100%;VISIBILITY:inherit;WIDTH:100%;Z-INDEX:2"></IFRAME></td>
  ...
  <tr> 
    <td height="32" valign="bottom"> 
      <div align="center">Powered by <a href="http://www.yunniupin.com" target="_blank"><strong><font color="#07519A">EmpireBak</font></strong> 
