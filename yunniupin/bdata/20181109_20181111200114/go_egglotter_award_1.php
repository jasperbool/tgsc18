...
E_D("replace into `go_egglotter_award` values('12','3','daili','1','1454173680','3');");
E_D("replace into `go_egglotter_award` values('13','3','daili','1','1454173746','3');");
E_D("replace into `go_egglotter_award` values('14','3','daili','1','1454173758','3');");
E_D("replace into `go_egglotter_award` values('15','3','daili','1','1454173767','3');");
E_D("replace into `go_egglotter_award` values('16','3','daili','1','1454173800','3');");
E_D("replace into `go_egglotter_award` values('17','3','daili','1','1454173806','3');");
E_D("replace into `go_egglotter_award` values('18','3','daili','1','1454173854','3');");
