...
E_D("replace into `go_caches` values('3','goods_count_num','73625');");
E_D("replace into `go_caches` values('4','template_mobile_reg','尊敬的用户您好,你的注册验证码是:000000,请不要告诉任何人。');");
E_D("replace into `go_caches` values('5','template_mobile_shop','恭喜你云购全球用户！您在云购全球够买的商品已中奖,获得的云购码为：00000000 请登陆网站查看详情！请尽快联系管理员发货！');");
