...
//        echo 'aaaa';
		...
		if(isset($_POST['submit'])){			
			...
			$sql="INSERT INTO `@#_member` ($regtype,password,img,emailcode,mobilecode,reg_key,yaoqing,yaoqing1,time)VALUES('$name','$userpassword','photo/member.jpg','1','1','$name','$decode','$decode1','$time')";
