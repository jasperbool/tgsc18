...
<div class="header lr10">
	...
	<a href="<?php echo G_MODULE_PATH; ?>/wechat/hbadd" style="float:right; margin-right:10px; background:#D80000; color:#FFF;height:30px;border-radius:50px;padding-left:10px; padding-right:10px;line-height:30px;margin-top:5px;">添加红包类型</a>
</div>
