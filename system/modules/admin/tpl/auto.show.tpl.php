...
.button1{color: #FFF; background: #161e22; padding:5px 15px 5px 15px;margin-right: 25px;float: right; margin-top: 10px; display: inline-block;border-radius: 50px; border: none; cursor: pointer;}

.button1:hover{background: #D80000; color:#ffff00;}

.btns{width: 30px; margin-right: 3px; border-radius: 50px; float: left; height: 30px; text-align: center; line-height: 30px; cursor: pointer;}
...
<div class="header lr10" style="height:42px; line-height:42px;">
  ...
  <font style="color:#D80000; font-weight:500">1、点击关闭后,如果想再次开起,需至少等待上次设置的间隔时间段(秒)的最大秒数
...
<input id="start_auto_p" type="button" value="保存配置" class="button1"/>
<input id="stop_auto_p" type="button" value="关闭" class="button1"/>
<a style="color: #FFF; background: #D80000;line-height:16px; padding:5px 15px 5px 15px;margin-right: 25px;float: right; margin-top: 10px; display: inline-block;border-radius: 50px; border: none; cursor: pointer;" href="/index.php/go/shua/shua" target="_blank">配置好后点击开始刷单</a></div>
</div>
</div>
	...
	<tr>
		...
		<?php for($i=0;$i<24;$i++){ ?>
				...
				<?php if($x == 1){?>
					...
					<div class="btns" style="background:#D80000;color:#fff;"><?php echo $i;?></div>
		...
		</br>指定购买小时段： <font style="color:red"><?php echo $timeperiod; ?></font></td>
	 ...
	 <table width="100%" cellspacing="0">
	 	...
	 	<thead>
				...
				<tr>
					...
					<th width="5%"><input id="cb_all" type="checkbox" /></th>
					...
					<th width="12%">已参与/总需</th>

					<th width="8%">单价/元</th>

					<th width="14%">期数/最大期数</th>
