...
<li class="title">云购助手</li>
         <li><a href="<?php echo WEB_PATH; ?>/api/upfile">系统版本</a></li>
	 <li><a href="<?php echo WEB_PATH; ?>/api/plugin/get/bom">BOM检测</a></li> 
        ...
        <li><a href="<?php echo WEB_PATH; ?>/admin/auto/show">自动购买</a></li>
		...
		<li><a href="<?php echo WEB_PATH; ?>/goodspecify/goodspecify/init">指定中奖</a></li><?php } ?>
