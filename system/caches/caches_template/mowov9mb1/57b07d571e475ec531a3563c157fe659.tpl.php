...
<li>
<input id="nickname" name="nickname" type="text" placeholder="请输入昵称" value="<?php echo $member['username']; ?>" style="padding-left: 60px;">
<span style="border: none;height: 34px;width: 60px;background-position: 0 -25px;position: absolute;top: 12px;left: 5px;">昵称：</span>
</li>
<!--<li>-->
...
<!--</li>-->
<li>
<a href="javascript:;" id="nickname_btn" class="nextBtn orgBtn">修改</a>
</li>
</ul>
</div>
</section>
...
$(function(){
    $('#nickname_btn').click(function(){
        ...
        if(!nickname){
            $.PageDialog.fail("请输入昵称");
            return false;
        }
        $.ajax({
            url: "/mobile/user/changeNickname",
            type: "post",
            dataType: "json",
