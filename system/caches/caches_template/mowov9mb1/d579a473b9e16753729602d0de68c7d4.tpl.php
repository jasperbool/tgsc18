...
<style type="text/css">
	*{margin:0;padding:0;}
	...
	.box-title{ background:<?php if(isset($config['titlebg'])): ?><?php echo $config['titlebg']; ?><?php  else: ?>#D80000<?php endif; ?>;height:30px;line-height:33px;_line-height:30px;font-size: 14px;color:<?php if(isset($config['title'])): ?><?php echo $config['title']; ?><?php  else: ?>#fff<?php endif; ?>; padding:0 10px;}
