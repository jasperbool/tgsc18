            ...
            function(s) {			 
                ...
                if (s.code == 0) {
                    ...
                    for (var q = 0; q < t; q++) {
                        ...
                        var v = '<ul id="' + r[q].codeID + '"><li class="revConL">' + (r[q].codeType == 1 ? '<span class="z-limit-tips">限时获得</span>': "") + '<img src="' + Gobal.LoadPic + '" src2="http://mimg.1yyg.com/goodspic/pic-200-200/' + r[q].codeGoodsPic + '"></li><li class="revConR"><dl><dd><img name="uImg" uweb="' + r[q].userWeb + '" src="http://faceimg.1yyg.com/UserFace/' + r[q].userPhoto + '"></dd><dd><span>获得者<strong>：</strong><a name="uName" uweb="' + r[q].userWeb + '" class="rUserName blue">' + r[q].userName + '</a></span>本期云购<strong>：</strong><em class="orange arial">' + r[q].codeRUserBuyCount + '</em>人次</dd></dl><dt>幸运云购码：<em class="orange arial">' + r[q].codeRNO + '</em><br/>获得时间：<em class="c9 arial">' + r[q].codeRTime + '</em></dt><b class="fr z-arrow"></b></li></ul>';
            ...
            var p = function(t) {
                ...
                for (var r = t.length - 1; r > -1; r--) {
                    ...
                    if (e.indexOf("," + s.codeID + ",") < 0) {
                        ...
                        var u = $('<ul class="rNow rFirst" id="' + s.codeID + '"><li class="revConL"><img src="http://mimg.1yyg.com/goodspic/pic-200-200/' + s.goodsPic + '"></li><li class="revConR"><h4>(第' + s.period + "期)" + s.goodsSName + "</h4><h5>价值：￥" + CastMoney(s.price) + '</h5><p name="pTime"><s></s>获得倒计时 <strong><em>00</em> : <em>00</em> : <em>0</em><em>0</em></strong></p><b class="fr z-arrow"></b></li><div class="rNowTitle">正在获得</div></ul>');
