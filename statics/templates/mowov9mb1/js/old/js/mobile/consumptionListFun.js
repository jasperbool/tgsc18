                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>充值时间</span><span>充值金额</span><span>充值方式</span></li>'
                        ...
                        for (var z = 0; z < A; z++) {
                            ...
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>' + C[z].time + "</span><span>￥" + C[z].money + "</span><span>在线充值</span></li>"
