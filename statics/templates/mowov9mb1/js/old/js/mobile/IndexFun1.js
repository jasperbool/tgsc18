$(function() {
                ...
                var m = function(r) {
                    ...
                    for (var o = r.length - 1; o > -1; o--) {
                        ...
                        if (g.indexOf("," + p.codeID + ",") < 0) {
                            g += p.codeID + ",";
                            var s = $('<div class="m-lott-conduct" id="' + p.codeID + '"><p class="z-lott-tt">(第' + p.period + "期)" + p.goodsSName + '<b class="z-arrow"></b><span class="z-lott-time">获得倒计时<span class="minute">00</span>:<span class="second">00</span>:<span class="millisecond">0</span><span class="last">0</span></span></p></div>');
                            s.click(function() {
	...
	(function(){
		...
		var update = function(info){
			...
			html += '		<span class="z-lott-time">获得倒计时';
