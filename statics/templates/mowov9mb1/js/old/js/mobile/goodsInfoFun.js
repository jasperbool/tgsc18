$(function() {
    ...
    if (m) {
        ...
        var i = function() {
            ...
            q.children("a").eq(2).click(function() {
        ...
        if (g.length > 0) {
            ...
            if (o) {
                ...
                g.html("<p><span>限时获得</span>剩余时间：<em>00</em>时<em>00</em>分<em>00</em>秒</p>");
                ...
                g.html("<p><span>限时获得</span>获得时间：<em>" + j[0] + "</em>月<em>" + j[1] + "</em>日<em>" + j[2] + "</em>点</p>")
