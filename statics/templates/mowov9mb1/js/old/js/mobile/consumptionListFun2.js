    ...
    var a = function() {	 
        ...
        var t = function() {
            ...
            var y = function() {
                ...
                GetJPData(Gobal.Webpath, "shopajax", "getZhuanmx"+w(),
                ...
                function(D) {
                    ...
                    if (D.code == 0) {
                        ...
                        if (v.isCount == 1) {
                            ...
                            B = '<li class="m-userMoneylst-tt"><span>转账时间</span><span>用户手机</span><span>转账金额</span></li>'
                        ...
                        for (var z = 0; z < A; z++) {
                            ...
                            B += '<li class="' + (z + 1 == A ? "bornone": "") + '"><span>' + C[z].time + "</span><span>" + C[z].phone + "</span><span>" + C[z].money + "元</span></li>"
