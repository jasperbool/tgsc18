...
jwebox.goshopnow = function(shopid,path){
		if(jwebox_shopid&&jwebox_shopid==shopid&&jwebox.DOMS['goshopnow']){		 
			...
			var html = jwebox.heredoc(function(){/*	
				...
				.jwebox_goshop{position: absolute;margin:314px;width: 300px;height: 200px;background: #dc332d;z-index: 999;}
				*{margin:0;padding:0;list-style-type:none;}
				...
				.jwebox_mainlist span a:hover{color:#fff;background-color:#dc332d;}
				...
				.jwebox_Det_Shopnow{width:94px;height: 34px;background: #dc332d;text-align: center;line-height: 32px;
				color: #fff;font-size: 14px;border-radius: 3px;display:block; float:left; margin-left:23px;}
				.jwebox_Det_Shopnow:hover{color:#fff;background:#dc332d;}
				.jwebox_mainlist_uspecies1{margin-top:20px;display:block;width:260px;height:50px;line-height:50px;background-color:#dc332d;border-radius:10px;color:#fff;font-size:16px;font-weight:600;}
				.buxianshi:hover{background-color:#fff!important;color:#dc332d!important;}
				</style>
			...
			var cgoodsinfo = jQuery.parseJSON(cgoodsdata);
                ...
                if(cgoodsinfo.ustatus==2){
                    ...
                    $(".jwebox_uspecies").html("<span style='color:#dc332d;font-weight:600;'>"+cgoodsinfo.umoney+"</span>");
                    ...
                    if(cgoodsinfo.ustatus==0){
                        ...
                        $(".jwebox_mainlist_uspecies").css("color","#dc332d");
...
shopnum.keyup(function(){			
	...
	$("#yshopchance").html("<span style='color:#dc332d'>获得机率"+baifenbi+"</span>");   			
});			
