        ...
        var u = function() {
            ...
            function(w) {
                ...
                if (w.code == 0) {
                    ...
                    s.removeClass("rNow").removeClass("rFirst").html('<a href="/mobile/mobile/dataserver/'+s.id+'"></a><li class="revConL">' + x + '<img src="'+Path.path+'/statics/uploads/'+ w.thumb + '"></li><li class="revConR"><dl><dd><img src="'+Path.path+'/statics/uploads/'+ w.user.img +'"></dd><dd>获得者：<em class="blue">' + w.user.username.substr(0,5) + '</em><br>购买：<em class="orange arial">' + w.buyCount + '</em>人次</dd></dl><dt>幸运码：<em class="orange arial">' + w.codeRNO + '</em><br>揭晓时间：<em class="c9 arial">' + w.codeRTime + '</em></dt><b class="fr z-arrow"></b></li>');
