                ...
                var y = function(I) {
                    if (I.code == 0) {
                        ...
                        for (var D = 0; D < C; D++) {
                            ...
                            if (F.codeState == 3) {
                                E += '<p class="mValue">价值：￥' + F.money + '</p><span>获得者：<a style="color: #2Af" href="'+Gobal.Webpath+'/mobile/mobile/userindex/' + F.q_uid + '">' + F.q_user + '</a><br>幸运码：<em class="orange">' + F.q_user_code + "</em></span>"
                            } else {
