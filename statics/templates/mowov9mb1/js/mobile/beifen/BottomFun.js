...
var addNumToCartFun = null; (function() {
    Gobal.Skin = "http://127.0.0.1/mowov9/statics/templates/yungou";
	//alert(Gobal.Skin);
    Gobal.LoadImg = null;
    ...
    var d = "http://127.0.0.1/mowov9/?/login";
    loadImgFun(0);
    var a = $("#fLoginInfo");
    GetJPData("http://127.0.0.1/mowov9/?/mobile/mobile", "getUInfo", "",
    function(h) {
        var g = '<span><a href="http://127.0.0.1/mowov9/?/mobile/mobile">首页</a><b></b></span><span><a href="/about.html">新手指南</a><b></b></span>';
        if (h.code == 0) {
    ...
    var c = $("#btnCart");
    if (c.length > 0) {
        GetJPData("http://127.0.0.1/mowov9/", "cartnum", "",
        function(g) {
            if (g.code == 0 && g.num > 0) {
                c.html("<em>" + g.num + "</em>")
            }
