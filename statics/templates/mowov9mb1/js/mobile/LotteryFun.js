            ...
            function(s) {			 
                ...
                if (s.code == 0) {
                    ...
                    for (var q = 0; q < t; q++) {
                     ...
                     // var v = '<ul class="rNow rFirst" id="'+ r[q].id +'">';
                      //    v+='<li class="revConL "><img src="' + Gobal.LoadPic + '" \/> <span>第'+r[q].qishu+'期</span></li>';
                     //     v+='<li class="revConR"><h4>'+r[q].title+'</h4>';
                      //    v+='<h5>价值：￥'+r[q].money+'</h5><p name="pTime">揭晓倒计时 <strong>' + r[q].q_end_time + '</strong>';
                      //    v+='</p><b class="fr z-arrow"></b></li><div class="rNowTitle">正在揭晓</div></ul>';
                        var u = $(v);
            ...
            var p = function(t) {
                ...
                for (var r = t.length - 1; r > -1; r--) {
                    ...
                    if (e.indexOf("," + s.id + ",") < 0) {
                        ...
                        var u = $('<ul class="rNow rFirst" id="' + s.id + '"><li class="revConL"><img src="'+Path.path+'/statics/uploads/'+ s.thumb + '"></li><li class="revConR"><h4>(第' + s.qishu + "期)" + s.title + "</h4><h5>价值：￥" + CastMoney(s.money) + '</h5><p name="pTime"><s></s><strong><em>00</em> : <em>00</em> : <em>0</em><em>0</em></strong></p><b class="fr z-arrow"></b></li><div class="rNowTitle">正在揭晓</div></ul>');
