       ...
       // g.children("a").click(function() {	
        ...
        var m = function() {
            ...
            if (r > 0) {
               ...
               // console.log("11");
                $("#setidnes").html('<p class="money-total">合计：&nbsp;<em class="orange">'+q+'&nbsp;元</em></p><p class="pro-total">总共&nbsp;<em>'+r+'&nbsp;</em>件商品</p>');
                //g.children("dl dt").html('总共购买<span class="orange arial z-user">' + r + '</span>个奖品  合计金额：<span class="orange arial">' + q + ".00</span> 元")
            } else {
                g.remove()
            }
        };
        var d = function() {
            ...
            var ony = t.replace("setone","");
           // var onz = ony.attr("data-value");
           // console.log(onz);
            var q = z.next().next();
