(function(a) {
    ...
    a.PageDialog.msgbox = function(g, c, b) {
        var e = null;
        var d = '<div class="clearfix m-round u-tipsEject"><div class="u-tips-txt">' + g + '</div><div class="u-Btn"><div class="u-Btn-li"><a id="btnMsgOK" href="javascript:;" class="z-DefineBtn">确定</a></div></div></div>';
        var f = function() {
            a("#btnMsgOK").click(function() {
                e.close()
            })
